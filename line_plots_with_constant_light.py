...
#parameter values
phi1 = 0.15 #interaction strength for p1
...
#plotting biomass
pro1 = axs[1,1].plot(np.log(P1.T[0]))
...
pro2 = axs[1,2].plot(np.log(P2.T[0]))
